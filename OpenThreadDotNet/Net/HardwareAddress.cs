...
namespace dotNETCore.OpenThread.Net
{
    ...
    public class HardwareAddress{
        ...
        public static readonly  HardwareAddress None = new HardwareAddress(new byte[0]);
        ...
        public static HardwareAddress Parse(string address) {
            ...
            if (address.IndexOf('-') >= 0 ){
                ...
                if(address.Length % 2 > 0){  //should be even
                    throw new SpinelFormatException("net_bad_mac_address");
                }
            ...
            return new HardwareAddress(buffer);
        }
    }
}
